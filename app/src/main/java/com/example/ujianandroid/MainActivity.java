...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) EditText edNamaDepan = findViewById(R.id.edNamaDepan);
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) EditText edNamaBelakang = findViewById(R.id.edNamaDepan);
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) Button btnSimpan = findViewById(R.id.btnSimpan);
